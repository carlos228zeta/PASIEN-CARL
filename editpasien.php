<html>
    <head>
        <title>My App | Halaman Utama</titl>
            ...
            <div class="row at-3">
                <div class="col-4">
                    ...
                    <form action="koneksi.php" method="POST">
                        ...
                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="jk" value="Laki-laki" <?php if (($row['k']) === "Laki-laki") {
                                echo "checked";
                            }?>>Laki-laki
                        </div>
                    </div>
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control" name="alamat" id="alamat" cols="5" rows="3" placeholder="Alamat"<?= $row
                            ['alamat']?>></textarea>
                        </div>
                        <div class="form-group at-3">
                            <input type="submit" name="sinpan" value="Sinpan" class="form-control btn btn-primary">
                        </div>
                    </form>
                    <?php } ?>
                </div>
